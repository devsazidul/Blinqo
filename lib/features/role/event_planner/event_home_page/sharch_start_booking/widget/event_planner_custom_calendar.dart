        ...
        return Column(
          children: [
            ...
            CalendarCarousel(
              ...
              headerTextStyle: getTextStyle(color: Color(0xff615E83)),
              ...
              markedDateIconBuilder: (event) {
                if (selectedDates.indexOf(event.date) == 0) {
                  return _buildCircle(event.date.day, const Color(0xffF0C020));
                } else {
                  return _buildCircle(event.date.day, const Color(0xffC0C0C0));
                }
              },
