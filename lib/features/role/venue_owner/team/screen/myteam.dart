        ...
        child: Column(
          ...
          children: [
           ...
           Obx((){
            ...
            return controller.teamList.isNotEmpty ? Text('${controller.teamList.length}  members',
            style: getTextStyle(
              fontSize: 14,
           ...
           if(controller.teamList.isEmpty){
            return Center(
             ...
             child: Image.asset(ImagePath.emptyTeam,width: double.infinity,fit: BoxFit.cover,),
             ), 
            );
           }else{
            return ListView.builder(physics: NeverScrollableScrollPhysics(),shrinkWrap: true,itemCount: controller.teamList.length,itemBuilder: (context,index){
             ...
             return Container(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('${member['firstName']} ${member['lastName']}',style: getTextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.w400,
                      color: Color(0xff333333),
                    ),),
                    SizedBox(height: 4,),
                    Text('${member['role']}',style: getTextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.w400,
                   ...
                   child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                             ...
                             },child: Image.asset(IconPath.personadd,height: 16,width: 22,fit: BoxFit.cover,)),
                             SizedBox(width: 10,),
                             Text('Add team member manually',style: getTextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.w400,
                              color: Color(0xff333333)
                             ),),
                      ...
                      Padding(
                        ...
                        child: Row(
                         children: [
                           Image.asset(IconPath.contacts,height: 24,width: 24,fit: BoxFit.cover,),
                           SizedBox(width: 10,),
                           Text('Add team member from contact',style: getTextStyle(
                            fontSize: 16,
