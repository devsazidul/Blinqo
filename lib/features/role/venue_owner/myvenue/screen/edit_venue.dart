              ...
              children: [
                ...
                Container(
                  ...
                  child: Image.asset(
                    ImagePath.location,
                    fit: BoxFit.cover,
                    opacity: const AlwaysStoppedAnimation(0.5), // 0.0 to 1.0, এখানে 50% opacity
                  ),
                ),
                ...
                Row(
                  ...
                  children: [
                  CustomShapeTag(label: 'Storage & lighting',  height: screenHeight * 0.04,
                    width: screenWidth * 0.38,
                    icon:Icon(Icons.wifi, size: 15, color: Color(0xffD4AF37)),

                  ),
                    SizedBox(width: .2,),
                    CustomShapeTag( icon:Icon(Icons.wifi, size: 15, color: Color(0xffD4AF37)),label: 'Sound System', height: screenHeight * 0.04, width:screenWidth * 0.38),
                  ],
                ),
                SizedBox(height: 16),
                Row(
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    CustomShapeTag(label: 'Event Staff',  height: screenHeight * 0.04,
                ...
                FittedBox(
                  fit: BoxFit.contain,
                  child: Obx(() {
                    final shapes = List<String>.from(controller.tableShapeOptions);

                    if (shapes.contains("Half-Moon") && shapes.contains("Banquet")) {
                    ...
                    Widget buildRow(List<String> shapeList) {
                      return Row(
                        ...
                        children: shapeList.map((shape) {
                          final isSelected = controller.selectedTableShapes.contains(shape); // এখানে ইউজ করো
                          return Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Transform.scale(
                                ...
                                child: Theme(
                                  data: Theme.of(context).copyWith(
                                    unselectedWidgetColor: const Color(0xffABB7C2), // unchecked border color
                                  ...
                                  child: Checkbox(
                                    value: isSelected,
                                    onChanged: (_) => controller.toggleTableShape(shape),
                                    activeColor: const Color(0xff003366), // or use .withOpacity(0.5) if needed
                                  ),
                                ),
                              ),
                ...
                FittedBox(
                  ...
                  child: Obx(() {
                    ...
                    // 3 করে ভাগ করা
                    final firstRowStyles = styles.take(3).toList(); // index 0,1,2
                    final secondRowStyles = styles.skip(3).take(3).toList(); // index 3,4,5

                    Widget buildRow(List<String> styleList) {
                      return Row(
                        mainAxisSize: MainAxisSize.min,
                        children: styleList.map((style) {
                          final isSelected = controller.selectedSeatingStyles.contains(style);
                          return Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Transform.scale(
                                ...
                                child: Theme(
                                  data: Theme.of(context).copyWith(
                                    ...
                                    checkboxTheme: CheckboxThemeData(
                                      ...
                                      side: const BorderSide(
                                        width: 1, // এখানে width কমিয়ে দিচ্ছি
                                        color: Color(0xff003366), // light grey border
                                      ),
                                    ),
                                  ),
                                  child: Checkbox(
                                    value: isSelected,
                                    onChanged: (_) => controller.toggleSeatingStyle(style),
                                    activeColor:  Color(0xff003366).withValues(alpha: .5),
                                  ),
                                ),
                              ),
                ...
                FittedBox(
                  fit: BoxFit.contain,
                  child: Obx(() {
                    final lightingStyles = List<String>.from(controller.LightingStyle);
                    ...
                    Widget buildRow(List<String> styleList) {
                      return Row(
                        mainAxisSize: MainAxisSize.min,
                        children: styleList.map((style) {
                          final isSelected = controller.selectedLightingStyles.contains(style);
                          return Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Transform.scale(
                                ...
                                child: Theme(
                                  data: Theme.of(context).copyWith(
                                    unselectedWidgetColor: const Color(0xffABB7C2),
                                    checkboxTheme: CheckboxThemeData(
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(2),
                                      ),
                                  ...
                                  child: Checkbox(
                                    value: isSelected,
                                    onChanged: (_) => controller.tooggleLightingStyle(style),
                ...
                FittedBox(
                  fit: BoxFit.contain,
                  child: Obx(() {
                    final flowerColors = List<String>.from(controller.FlowerColor);
                    final firstRowColors = flowerColors.take(4).toList(); // Ends with "Pink"
                    final secondRowColors = flowerColors.skip(4).toList(); // Starts with "Purple"

                    Widget buildRow(List<String> colorList) {
                      return Row(
                        mainAxisSize: MainAxisSize.min,
                        children: colorList.map((color) {
                          final isSelected = controller.selectedFlowerColor.contains(color);
                          return Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Transform.scale(
                                ...
                                child: Theme(
                                  ...
                                  child: Checkbox(
                                    value: isSelected,
                                    onChanged: (_) => controller.toogleFlowerColor(color),
                                    activeColor: const Color(0xff003366),
                                  ),
                                ),
                              ),
                    ...
                    Widget buildRow(List<String> typeList) {
                      return Row(
                        ...
                        children: typeList.map((type) {
                          final isSelected = controller.selectedFlowerType.contains(type);
                          return Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Transform.scale(
                                ...
                                child: Theme(
                                  ...
                                  child: Checkbox(
                                    value: isSelected,
                                    onChanged: (_) => controller.toogleFlowerType(type),
                                    activeColor: const Color(0xff003366),
                                  ),
                                ),
                              ),
                ...
                FittedBox(
                  ...
                  child: Obx(() {
                    ...
                    if (scents.contains("Herba; Scents") && scents.indexOf("Herba; Scents") != 2) {
                      scents.remove("Herba; Scents");
                      scents.insert(2, "Herba; Scents");
                    }

                    final firstRowScents = scents.take(3).toList(); // Ends with "Herba; Scents"
                    final secondRowScents = scents.skip(3).toList();

                    Widget buildRow(List<String> scentList) {
                      return Row(
                        mainAxisSize: MainAxisSize.min,
                        children: scentList.map((scent) {
                          final isSelected = controller.selectedFragrance.contains(scent);
                          return Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Transform.scale(
                                ...
                                child: Theme(
                                  ...
                                  child: Checkbox(
                                    value: isSelected,
                                    onChanged: (_) => controller.toogleFrance(scent),
                                    activeColor: const Color(0xff003366),
                                  ),
                                ),
                              ),
