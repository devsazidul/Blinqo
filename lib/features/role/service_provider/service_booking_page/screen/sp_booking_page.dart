      ...
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: CircleAvatar(
            ...
            child: Image.asset(IconPath.arrowleft, width: 16, height: 12),
          ),
        ),
        centerTitle: true,
        title: Text(
          ...
          child: Column(
            children: [
              ...
              Column(
                ...
                children: const [
                  StatusLabel(color: AppColors.darkTextColor, label: 'Booked'),
                  SizedBox(height: 8),
                  StatusLabel(color: AppColors.buttonColor, label: 'Selected'),
                ],
              ),
              SizedBox(height: 12),
              Container(
