...
class SpUser {
  ...
  factory SpUser.fromJson(Map<String, dynamic> json) {
    return SpUser(
      ...
      profile:
          json["profile"] == null ? null : SpProfile.fromJson(json["profile"]),
    );
  }
...
class SpProfile {
  ...
  factory SpProfile.fromJson(Map<String, dynamic> json) {
    return SpProfile(
      id: json["id"],
      userId: json["userId"],
      name: json["name"],
...
class CoverPhoto {
  ...
  factory CoverPhoto.fromJson(Map<String, dynamic> json) {
    return CoverPhoto(path: json["path"]);
  }
...
class EventPreference {
  ...
  EventPreference copyWith({String? id, String? name, CoverPhoto? avatar}) {
  ...
  factory EventPreference.fromJson(Map<String, dynamic> json) {
    return EventPreference(
      ...
      name: json["name"],
      avatar:
          json["avatar"] == null ? null : CoverPhoto.fromJson(json["avatar"]),
    );
  }
